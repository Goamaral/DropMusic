...
public interface AlbumInterface extends Remote {
    ArrayList<Album> index() throws RemoteException, CustomException;
    ...
    ArrayList<StoredSong> user_uploads(int user_id, int song_id) throws RemoteException, CustomException;
    void song_share(int song_id, int user_id) throws RemoteException, CustomException;

    // Genres
    ArrayList<Genre> genres_all() throws RemoteException, CustomException;
    ...
    ArrayList<Genre> song_genres(Song song) throws RemoteException, CustomException;
    ...
    ArrayList<Artist> song_artists(Song song) throws RemoteException, CustomException;
